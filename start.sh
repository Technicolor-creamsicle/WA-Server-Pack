...
if ! screen -list | grep -q "mc"; then
	...
	sudo screen -dmS mc sudo java -server -XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:+CMSIncrementalPacing -XX:+AggressiveOpts -Xms1G -Xmx10G -jar Thermos-1.7.10-1614-server.jar nogui
else
